...
Page({
    ...
    onShareAppMessage: function() {
        ...
        return this.data.userInfo.id ? {
            title: t && e ? e : t,
            path: "sis_shiyi/pages/newcms/todayup/todayup?id=" + this.data.id + "&fxid=" + this.data.userInfo.id + "&fxtype=fx"
        } : {
            title: t && e ? e : t,
            path: "sis_shiyi/pages/newcms/todayup/todayup?id=" + this.data.id
        };
    },
    shareMenu: function() {
        this.setData({
