...
util.url = function(e, t, a) {
    var n = (a = getApp()).siteInfo.siteroot + "?i=" + a.siteInfo.uniacid + "&t=" + a.siteInfo.multiid + "&v=" + a.siteInfo.version + "&from=wxapp&";
    ...
    if (wx.showNavigationBarLoading(), n.showLoading && util.showLoading(), n.cachetime) {
        ...
        if (c && c.data) {
            ...
            n.success && "function" == typeof n.success && n.success(c), wx.hideLoading(), wx.hideNavigationBarLoading(), 
            !0;
